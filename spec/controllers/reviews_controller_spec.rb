...
#   let(:valid_attributes) { { "membership" => "" } }
...
#         post :create, {:review => { "membership" => "invalid value" }}, valid_session
#         assigns(:review).should be_a_new(Review)
#       end
...
#         Review.any_instance.should_receive(:update).with({ "membership" => "" })
#         put :update, {:id => review.to_param, :review => { "membership" => "" }}, valid_session
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Review.any_instance.stub(:save).and_return(false)
#         put :update, {:id => review.to_param, :review => { "membership" => "invalid value" }}, valid_session
#         assigns(:review).should eq(review)
#       end
